...
/**
 * Description:
 *      按字段长度读取一个完整的Frame，实现和Netty自带的完全一样<br>
 * 主要如下改动<br>
 *
 * 1.实现了InnerDecoder了接口
 * 2.把ByteToMessageDecoder里的protected的decode方法开放出来<br>
 * 3.需要子类实现对一次完整frame的解析为object的抽象方法<br>
 * <p/>
 * Company: <a href=www.le.com>LeEco</a><br/>
 *
 * @see io.netty.handler.codec.LengthFieldBasedFrameDecoder
 */
public abstract class LengthFieldBasedFrameDecoder extends ByteToMessageDecoder {
     ...
     * @return 解析的object
     */
    public abstract Object decodeFrame(ByteBuf frame);
