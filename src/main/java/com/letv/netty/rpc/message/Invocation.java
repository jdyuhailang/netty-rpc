...
public class Invocation implements Serializable {
    ...
    private transient Map<String, Object> transientAttachments = new HashMap<String, Object>();
    ...
    public void addTransientAttachment(String key, Object value) {
        if (value == null) {
            transientAttachments.remove(key);
        } else {
    ...
    public Object getTransientAttachment(String key) {
        return transientAttachments.get(key);
    }

    public Map<String, Object> getTransientAttachments() {
