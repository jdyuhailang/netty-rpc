...
public class ServerTransportConfig {
    ...
    private synchronized EventLoopGroup initParentEventLoopGroup(){
        ...
        NamedThreadFactory threadName = new NamedThreadFactory("LEDO-SEV-BOSS", isDaemon());
    ...
    private synchronized EventLoopGroup initChildEventLoopGroup(){
        ...
        NamedThreadFactory threadName = new NamedThreadFactory("LEDO-SEV-WORKER", isDaemon());
