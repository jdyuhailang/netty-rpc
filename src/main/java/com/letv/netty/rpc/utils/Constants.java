...
public class Constants {
     ...
     * 内部版本
     */
    public static final int DEFAULT_LEDO_INTERNAL_VERSION = 216;

    /**
     * 当前LEDO版本，例如：<br>
     * 2.0.0-SNAPSHOT对应2000<br>
     * 2.0.0 release对应2001
     */
    public static final int LEDO_VERSION = 2001;

    /**
     * 当前Build版本，每次发布修改  //FIXME
     */
    public static final String LEDO_BUILD_VERSION = "2.0.0_201612141850";


    /**
     * LEDO协议头的魔术位
     */
    public static final byte[] MAGIC_CODE_BYTE = new byte[]{(byte) 0xAE, (byte) 0xDA};
     ...
     * zookeeper注册中心
     */
    public static final String REGISTRY_PROTOCOL_ZK = "ledoZooKeeper";
    /**
     * xml文件注册中心
     */
     ...
     * 注册中心
     */
    public static final String REGISTRY_PROTOCOL_LEDO = "ledoRegistry";
     ...
     * 默认协议类型:ledo
     */
    public final static ProtocolType DEFAULT_PROTOCOL_TYPE = ProtocolType.ledo;

    /**
     * 默认协议:ledo
     */
    public final static String DEFAULT_PROTOCOL = "ledo";
     ...
     */
    public static final int DEFAULT_SERVER_PORT = 21600;
     ...
     * 客户端channelhandler名字
     */
    public static final String CLIENT_CHANNELHANDLE_NAME = "LEDO_CLIENT_CHANNELHANDLE";
     ...
     * 隐藏属性的key：对端的LEDO版本
     */
    public static final String HIDDEN_KEY_DST_LEDO_VERSION = HIDE_KEY_PREFIX + "dstLedoVer";
    /**
     * 隐藏属性的key：对端的语言
     */
     ...
     * 隐藏属性的key：是否是rest请求
     */
    public static final String HIDDEN_KEY_REST = HIDE_KEY_PREFIX + "rest";
    ...
    /**
     * 配置key:ledoInVer ledo 内部版本
     */
    public static final String CONFIG_KEY_LEDO_INTERNAL_VERSION = "ledoInVer";
     ...
     * 配置key:ledoVersion
     */
    public static final String CONFIG_KEY_LEDOVERSION = "ledoVersion";
     ...
     * 接口级设置：监控TP Step
     */
    public static final String SETTING_MONITOR_PERCENTILE_STEP = "mntr.percentile.step";
     ...
     * =========================================================
     */
    public static final String GOV_HOST = "http://ledo.letv.com";

    public static final String GOV_ERROR_RESOURCE = "ledo-error-code.html";
    ...
    public enum HeadKey {
        ...
        ledoVersion((byte) 7, Short.class), // 客户端的LEDO版本
