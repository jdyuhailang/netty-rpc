...
//
// Version: 1.5.0 final
public class LedoQuickLZUtil implements ICompress {
    ...
    private static LedoQuickLZUtil instance = new LedoQuickLZUtil();

    private LedoQuickLZUtil() {

    }

    public static LedoQuickLZUtil getInstance() {
        return instance;
    }
