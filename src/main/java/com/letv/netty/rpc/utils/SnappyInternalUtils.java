...
final class SnappyInternalUtils
{
    ...
    static {
        ...
        if (memoryInstance == null) {
            try {
                Class<? extends Memory> slowMemoryClass = SnappyInternalUtils.class.getClassLoader().loadClass("com.le.ledo.protocol.compress.snappy.SlowMemory").asSubclass(Memory.class);
